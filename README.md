...
```
#### 📊 4.3 Giao diện Giám sát Thực tế trên Seq (Live Monitoring UI)

Dưới đây là hình ảnh thực tế hệ thống thu thập log tập trung và truy vết luồng đi của Request thông qua `CorrelationId` trên giao diện Seq khi vận hành:

![Seq Live Logs Monitoring](https://github.com/nguyenthinh28902/mini-project-ecommerce/blob/main/images/seq-logs-order-and-product-service.png)
